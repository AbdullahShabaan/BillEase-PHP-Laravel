...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Bill Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Search</span>
						</div>
					</div>
...
<div class="card-header pb-0">
                ...
                <form action='{{url("SearchBill")}}' role="search" autocomplete="off" method="post">
                ...
                <div>
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input 
                         	checked
                            name="radio" type="radio" value="1" id="type_div"> <span>bill Status </span></label>
                    </div>
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input 
                            ...
                            name="radio" value="2" type="radio"><span>Bill Number  
                            </span></label>
                    </div><br><br>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">Select Bill Status</p><select class="form-control select2" name="type"
                                required>
                                <option value="{{ $type ?? 'Select Status'}}" selected >{{ $type_name ?? 
                                	'Select Status' }}
                                </option>

                                <option value="1">Paid Bills</option>
                                <option value="2"> UnPaid Bills </option>
                                <option value="3"> Partialy Paid Bills</option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            <p class="mg-b-10">Bill Number  </p>
                            <input type="text" value="{{$invoice_number ?? ''}}" class="form-control" id="invoice_number" placeholder="Number" name="invoice_number">
