            ...
            <div class="card">
                <div class="card-body">
                    <form   enctype="multipart/form-data"
                        autocomplete="off" method="post" action="{{route('bills.store')}}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="category" class="form-control select2" onclick="console.log($(this).val())"
                            ...
                            <div class="col">
                                ...
                                <input placeholder="0" type="text" class="form-control" id="inputName" name="collected_amount"
	                  ...
	                  <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea placeholder="...." class="form-control" id="exampleTextarea" name="note" rows="3"></textarea>
                            </div>
                        </div><br>
