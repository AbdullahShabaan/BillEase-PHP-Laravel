                                            ...
                                            <div class="main-signup-header">
                                                ...
                                                <form action="{{ route('login') }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Email</label> <input id="email" class="form-control @error('email') is-invalid @else is-valid @enderror" placeholder="Enter your email" type="text" name="email">
                                                    </div>
                                                    @error('email')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                    <div class="form-group">
                                                        <label>Password</label> <input id="password" class="form-control @error('password') is-invalid @else is-valid @enderror" placeholder="Enter your password" type="password"  name="password">
                                                    </div>
                                                     @error('password')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
